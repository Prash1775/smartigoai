...
class IeltsOnboardingScreen extends ConsumerStatefulWidget {
  final String uid;

  const IeltsOnboardingScreen({super.key, required this.uid});

  @override
  ConsumerState<IeltsOnboardingScreen> createState() =>
      _IeltsOnboardingScreenState();
}

class _IeltsOnboardingScreenState extends ConsumerState<IeltsOnboardingScreen> {
  int _currentStep = 0;
  bool isLoading = false;

  // Step 1: Target Score
  double selectedBand = 7.0;
  ...
  Future<void> _handleComplete() async {
    ...
    try {
      await FirestoreService.updateUser(widget.uid, {
        ...
        'targetScore': selectedBand.toInt(),
  ...
  Widget _buildStep() {
    switch (_currentStep) {
      case 0:
        return _buildTargetScoreStep();
      case 1:
        return _buildCurrentLevelStep();
      case 2:
        return _buildExamDateStep();
      case 3:
        return _buildWeakAreasStep();
      case 4:
      ...
      children: [
        ...
        Center(
          child: Container(
            ...
            child: Center(
              child: Text(
                selectedBand.toStringAsFixed(1),
        ...
        SliderTheme(
          ...
          child: Slider(
            ...
            onChanged: (value) => setState(() => selectedBand = value),
          ),
        ),
        const SizedBox(height: 8),
        Center(
          child: Text(
            'Band ${selectedBand.toStringAsFixed(1)} — ${_getBandDescription(selectedBand)}',
  ...
  Widget _buildCurrentLevelStep() {
    ...
    final levels = [
      {
        'value': 'beginner',
        'title': 'Beginner',
        'subtitle': 'Just starting IELTS preparation',
        'icon': Icons.school_outlined,
      },
      {
        'value': 'intermediate',
        'title': 'Intermediate',
        'subtitle': 'Have some practice, need improvement',
        'icon': Icons.trending_up,
      },
      {
        'value': 'advanced',
        'title': 'Advanced',
        'subtitle': 'Strong base, targeting high band',
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'This helps us customize your study plan.',
          style: theme.textTheme.bodyMedium?.copyWith(color: Colors.grey[600]),
        ),
        const SizedBox(height: 32),
        ...levels.map((level) {
  ...
  Widget _buildExamDateStep() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'We\'ll create a day-by-day plan leading up to your exam.',
          style: theme.textTheme.bodyMedium?.copyWith(color: Colors.grey[600]),
        ),
        const SizedBox(height: 40),
        Center(
            ...
            children: [
              ...
              if (examDate != null) ...[
                ...
                Container(
                  ...
                  child: Text(
                    '${examDate!.difference(DateTime.now()).inDays} days until your exam',
                    style: TextStyle(
  ...
  Widget _buildWeakAreasStep() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Select all areas you want to improve. We\'ll focus your study plan on these.',
          style: theme.textTheme.bodyMedium?.copyWith(color: Colors.grey[600]),
        ),
        const SizedBox(height: 32),
        Wrap(
  ...
  Widget _buildDailyTimeStep() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Be realistic — consistency beats long sessions!',
          style: theme.textTheme.bodyMedium?.copyWith(color: Colors.grey[600]),
        ),
        const SizedBox(height: 32),
        ...timeOptions.map((option) {
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () =>
                  setState(() => dailyMinutes = option['minutes'] as int),
              child: AnimatedContainer(
                duration: const Duration(milliseconds: 200),
                padding: const EdgeInsets.all(18),
                decoration: BoxDecoration(
